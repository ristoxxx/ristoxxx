...
<div align="center">
  <a href="mailto:lahteri@gmail.com" style="text-decoration: none;">
    <table>
      <tr>
        <td align="center" style="border-radius:10px; background-color:#4CAF50; padding:10px 20px;">
          <span style="color:white; font-weight:bold; font-size:16px;">🚀 HIRE ME FOR YOUR NEXT PROJECT</span>
        </td>
      </tr>
    </table>
  </a>
